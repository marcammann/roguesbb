...
class SchedulesController(BaseController):
	...
	def query(self, request):
		...
		if param_departure_time is None and param_arrival_time is None:
			param_departure_time = datetime.now()
...
</ReqC>""".format(departure_id=param_departure_id, arrival_id=param_arrival_id, is_arrival_time=0, formatted_date='20101028', formatted_time='10:30', means_mask=param_means_mask)
